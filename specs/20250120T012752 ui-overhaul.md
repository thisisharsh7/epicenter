...
3. **File uploads**: Leverage existing FileDropZone component from @epicenter/ui
...
<script lang="ts">
  ...
  import { FileDropZone, ACCEPT_AUDIO, ACCEPT_VIDEO, MEGABYTE } from '@epicenter/ui/file-drop-zone';
...
3. **File Upload**: Uses existing FileDropZone from @epicenter/ui, matching the drag-and-drop pattern from the other app
