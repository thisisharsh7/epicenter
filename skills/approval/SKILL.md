---
name: approval
description: Guidelines for expensive and destructive actions requiring user approval. Use before running tests, builds, commits, pushes, or any action that modifies permanent project state.
---
