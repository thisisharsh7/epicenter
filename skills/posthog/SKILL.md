---
name: posthog
description: PostHog analytics integration for Astro projects. Use when adding analytics, tracking events, implementing feature flags, or working with PostHog in the codebase.
---
