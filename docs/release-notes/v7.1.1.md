...
## New Contributors
* @shanelindsay made their first contribution in https://github.com/EpicenterHQ/epicenter/pull/509

**Full Changelog**: https://github.com/EpicenterHQ/epicenter/compare/v7.1.0...v7.1.1
