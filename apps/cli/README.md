...
The Epicenter CLI uses a custom fork of the [sst/opencode](https://github.com/sst/opencode) project, maintained at [`@epicenter/opencode`](https://github.com/EpicenterHQ/opencode). This fork adds essential CORS (Cross-Origin Resource Sharing) support, allowing epicenter.sh to communicate with your local OpenCode server from the browser without a middleman proxy server.
...
- [`@epicenter/opencode`](https://github.com/EpicenterHQ/opencode) - Our fork of OpenCode with CORS support for browser integration
