...
export const OpenRouterCompletionServiceLive = createOpenAiCompatibleCompletionService({
...
export type OpenRouterCompletionService = typeof OpenRouterCompletionServiceLive;
